...
class IndividualUser(PoshUser):
    ...
    profile_pic = models.ImageField(blank=True, upload_to='users/', null=True)
    aadhar = models.CharField(max_length=20, blank=True, null=True)
    marital = models.CharField(max_length=10, blank=True, null=True)
    description = models.TextField(max_length=500, blank=True, null=True)
    current_member = models.CharField(max_length=10, blank=True, null=True)
    ...
    firm_uid = models.CharField(max_length=15, blank=True, null=True)
    is_visible = models.BooleanField(default=False)
